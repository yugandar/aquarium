...
$mail->Username = 'phpdeveloper@brihaspathi.com';          // SMTP username
$mail->Password = 'brihaspathi123'; // SMTP password
$mail->SMTPSecure = 'ssl';                  // Enable TLS encryption, `ssl` also accepted
$mail->Port = 465;                          // TCP port to connect to

$mail->setFrom('phani@brihaspathi.com', 'Resume');
$mail->addReplyTo($to, 'Resume');
$mail->addAddress($to);   // Add a recipient
$mail->addCC('info@brihaspathi.com');
