...
<head>
	...
	<meta name="google-site-verification" content="Ew2d6XW8iFN3SMhQB6aBe2ZlF4MscyjJqIx0nBJZICc" />
	<!-- Favicon -->
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-135069131-1"></script>
	<script>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-sm-6 col-xs-12">
				<div class="left">
					<ul>
						<li><i class="fa fa-phone"></i> <?php echo "+91-".$contact_phone; ?></li>
		...
		<div class="row inner">
			...
			<div class="col-md-5 right">
				<ul>
					...
					<li><a href="cart.php"><i class="fa fa-shopping-basket"></i> <?php echo LANG_VALUE_19; ?> (<?php echo LANG_VALUE_1; ?><?php
				...
				<div class="menu-container">
					<div class="menu">
						<ul>
							...
							?>
       							<li><a href="customised-aquarium.php">Customised Aquarium</a></li>
