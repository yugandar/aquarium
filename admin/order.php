...
$mail->setFrom('phani@brihaspathi.com', $subject_text);
$mail->addReplyTo($cust_email, '');
$mail->addAddress($to_customer);   // Add a recipient
            	...
            	foreach ($result as $row) {
					...
					<tr class="<?php if($row['payment_status']=='Pending'){echo 'bg-r';}else{echo 'bg-g';} ?>">
	                    ...
	                    <td>
	                      ...
	                      <a href="order-print.php?id=<?php echo $row['id']; ?>" ><img src="printer-.png" style="
    height: 31px;
    text-align: center;
    margin: 37px 3px 2px 16px;
"></a>
